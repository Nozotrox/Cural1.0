...
class toAddRetirados(QDialog, addToRetiradas.Ui_addToRetiradas):
    def __init__(self, parent = None):
        super(toAddRetirados, self).__init__(parent)
        self.setupUi(self)
        self.setDB()
        self.setBtnConnections()
        self.setModelToWidget()
        self.listOfWidgets = [
            self.idRetiradosComboBox,
            self.dataRetiradaDateTimeEdit,
    ...
    def setModelToWidget(self):
        ...
        mixedModel.setModel4CombBox(tblName = 'tbl_gado', lstNames = 'id', widg = self.idRetiradosComboBox, namePos=0)
    ...
    def submit(self):
        ...
        list_of_values = [
            '2',
            str(self.idRetiradosComboBox.currentText()),
            self.formatDate(src.getText(self.dataRetiradaDateTimeEdit)),
